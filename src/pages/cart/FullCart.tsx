...
import { giveCartData } from '../../store/selectors';
import { actions } from '../../store/slices/curt/curt';


const FullCart: React.FC = () => {

    const cartData = useSelector(giveCartData);
            ...
            <div className="cart">
                <div className="cart__top">
                    <h2 className="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        Корзина</h2>
                    <div onClick={onCartClear} className="cart__clear">
                ...
                {[...new Array(cartData.countForRender)].map((_, i) => <CartPosition data={cartData.pizzas[i]}/>)}


                </div>
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <span> Всего пицц: <b>{cartData.totalPizzaCount} шт.</b> </span>
                        <span> Сумма заказа: <b>{cartData.totalPrice} ₽</b> </span>
                    </div>
